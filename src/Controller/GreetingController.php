...
final class GreetingController extends AbstractController
{
    ...
    {
        return $this->render('@SynoliaSyliusMaintenancePlugin/static_greeting.html.twig', ['greeting' => $this->getGreeting($name)]);
    }

    public function dynamicallyGreetAction(?string $name): Response
    {
        return $this->render('@SynoliaSyliusMaintenancePlugin/dynamic_greeting.html.twig', ['greeting' => $this->getGreeting($name)]);
    }
